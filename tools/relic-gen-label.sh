...
echo "#if defined(MULTI)"
echo "#undef core_thread_initializer"
echo "#define core_thread_initializer	RLC_PREFIX(core_thread_initializer)"
echo "#undef core_init_ptr"
echo "#define core_init_ptr				RLC_PREFIX(core_init_ptr)"
echo "#endif"
echo
REDEF core
REDEF arch
