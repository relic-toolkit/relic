...
static void clhe(int compact) {
	...
	if (compact) {
		BENCH_ONE("cp_clhe_set (compact)", cp_clhe_set(c, q, BENCH_CLHE_DISC,
				compact), 1);
	} else {
		BENCH_ONE("cp_clhe_set (plain)", cp_clhe_set(c, q, BENCH_CLHE_DISC,
				compact), 1);
	}
