...
void fp2_muln_c0(dv_t c, const fp2_t a, const fp2_t b);
void fp2_muln_c1(dv_t c, const fp2_t a, const fp2_t b);
...
void fp2_mulm_c0(dv_t c, const fp2_t a, const fp2_t b);
