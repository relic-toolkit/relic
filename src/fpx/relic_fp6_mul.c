...
void fp6_mul_basic3(fp6_t c, const fp6_t a, const fp6_t b) {
	...
	RLC_TRY {
		...
		fp2_add(v0, c[0], c4);
		fp_sub(v1[0], c[1][0], c[1][1]);
		fp_add(v1[1], c[1][1], c[1][0]);
		fp_hlv(v1[0], v1[0]);
		fp_hlv(v1[1], v1[1]);
		fp_add(v2[0], c[1][0], c[1][1]);
		fp_sub(v2[1], c[1][1], c[1][0]);
		fp_hlv(v2[0], v2[0]);
		fp_hlv(v2[1], v2[1]);
		fp_sub(t1[0], c[2][0], c[2][1]);
		fp_add(t1[1], c[2][1], c[2][0]);
		fp_hlv(t1[0], t1[0]);
		fp_hlv(t1[1], t1[1]);
		fp_add(t2[0], c[2][0], c[2][1]);
		fp_sub(t2[1], c[2][1], c[2][0]);
		fp_hlv(t2[0], t2[0]);
		fp_hlv(t2[1], t2[1]);
		...
		fp_add(t0[0], v0[1], c3[0]);
		fp_sub(t0[1], c3[1], v0[0]);
		//fp2_mul_art(v0, v0);
		//fp2_sub(v0, v0, c3);
		fp2_sub(c[1], v2, t0);
		fp2_sub(c[1], c[1], t1);
