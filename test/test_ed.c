...
static int simultaneous(void) {
	...
	RLC_TRY {
		...
		TEST_CASE("simultaneous point multiplication is correct") {
			...
			bn_rand_mod(k[1], n);
			ed_mul(p[1], p[0], k[1]);
			ed_mul_sim(r, p[0], k[0], p[0], k[1]);
			TEST_ASSERT(ed_cmp(p[1], r) == RLC_EQ, end);
			bn_rand_mod(k[0], n);
			bn_zero(k[1]);
			ed_mul(p[1], p[0], k[0]);
			ed_mul_sim(r, p[0], k[0], p[0], k[1]);
		...
		TEST_CASE("basic simultaneous point multiplication is correct") {
			...
			bn_rand_mod(k[1], n);
			ed_mul(p[1], p[0], k[1]);
			ed_mul_sim_basic(r, p[0], k[0], p[0], k[1]);
			TEST_ASSERT(ed_cmp(p[1], r) == RLC_EQ, end);
			bn_rand_mod(k[0], n);
			bn_zero(k[1]);
			ed_mul(p[1], p[0], k[0]);
			...
			bn_rand_mod(k[0], n);
			bn_rand_mod(k[1], n);
			ed_mul_sim_basic(r, p[0], k[0], p[1], k[1]);
			ed_mul(p[0], p[0], k[0]);
			ed_mul(p[1], p[1], k[1]);
			ed_add(p[1], p[1], p[0]);
			TEST_ASSERT(ed_cmp(p[1], r) == RLC_EQ, end);
		...
		TEST_CASE("shamir's trick for simultaneous multiplication is correct") {
			...
			bn_rand_mod(k[1], n);
			ed_mul(p[1], p[0], k[1]);
			ed_mul_sim_trick(r, p[0], k[0], p[0], k[1]);
			TEST_ASSERT(ed_cmp(p[1], r) == RLC_EQ, end);
			bn_rand_mod(k[0], n);
			bn_zero(k[1]);
			ed_mul(p[1], p[0], k[0]);
			...
			bn_rand_mod(k[0], n);
			bn_rand_mod(k[1], n);
			ed_mul_sim_trick(r, p[0], k[0], p[1], k[1]);
			ed_mul(p[0], p[0], k[0]);
			ed_mul(p[1], p[1], k[1]);
			ed_add(p[1], p[1], p[0]);
			TEST_ASSERT(ed_cmp(p[1], r) == RLC_EQ, end);
		...
		TEST_CASE("interleaving for simultaneous multiplication is correct") {
			...
			bn_rand_mod(k[1], n);
			ed_mul(p[1], p[0], k[1]);
			ed_mul_sim_inter(r, p[0], k[0], p[0], k[1]);
			TEST_ASSERT(ed_cmp(p[1], r) == RLC_EQ, end);
			bn_rand_mod(k[0], n);
			bn_zero(k[1]);
			ed_mul(p[1], p[0], k[0]);
			...
			bn_rand_mod(k[0], n);
			bn_rand_mod(k[1], n);
			ed_mul_sim_inter(r, p[0], k[0], p[1], k[1]);
			ed_mul(p[0], p[0], k[0]);
			ed_mul(p[1], p[1], k[1]);
			ed_add(p[1], p[1], p[0]);
			TEST_ASSERT(ed_cmp(p[1], r) == RLC_EQ, end);
		...
		TEST_CASE("jsf for simultaneous multiplication is correct") {
			...
			bn_rand_mod(k[1], n);
			ed_mul(p[1], p[0], k[1]);
			ed_mul_sim_joint(r, p[0], k[0], p[0], k[1]);
			TEST_ASSERT(ed_cmp(p[1], r) == RLC_EQ, end);
			bn_rand_mod(k[0], n);
			bn_zero(k[1]);
			ed_mul(p[1], p[0], k[0]);
			...
			bn_rand_mod(k[0], n);
			bn_rand_mod(k[1], n);
			ed_mul_sim_joint(r, p[0], k[0], p[1], k[1]);
			ed_mul(p[0], p[0], k[0]);
			ed_mul(p[1], p[1], k[1]);
			ed_add(p[1], p[1], p[0]);
			TEST_ASSERT(ed_cmp(p[1], r) == RLC_EQ, end);
		...
		TEST_CASE("simultaneous multiplication with generator is correct") {
			...
			bn_rand_mod(k[0], n);
			bn_rand_mod(k[1], n);
			ed_mul_sim_gen(r, k[0], p[1], k[1]);
			ed_curve_get_gen(p[0]);
			ed_mul_sim(p[1], p[0], k[0], p[1], k[1]);
			TEST_ASSERT(ed_cmp(p[1], r) == RLC_EQ, end);
			bn_neg(k[0], k[0]);
			ed_mul_sim_gen(r, k[0], p[1], k[1]);
			ed_curve_get_gen(p[0]);
		...
		TEST_CASE("many simultaneous point multiplications are correct") {
			ed_set_infty(r);
			ed_mul_sim_lot(p[16], p, k, 0);
			TEST_ASSERT(ed_cmp(p[16], r) == RLC_EQ, end);
			for (int j = 0; j < 16; j++) {
				bn_rand_mod(k[j], n);
				ed_rand(p[j]);
				ed_mul(p[16], p[j], k[j]);
				ed_add(r, r, p[16]);
				ed_mul_sim_lot(p[16], p, k, j + 1);
				TEST_ASSERT(ed_cmp(p[16], r) == RLC_EQ, end);
			}
			ed_mul(p[16], p[0], k[0]);
			ed_sub(r, r, p[16]);
			bn_zero(k[0]);
			ed_mul_sim_lot(p[16], p, k, 16);
			TEST_ASSERT(ed_cmp(p[16], r) == RLC_EQ, end);
			ed_mul(p[16], p[1], k[1]);
			ed_sub(r, r, p[16]);
			ed_sub(r, r, p[16]);
